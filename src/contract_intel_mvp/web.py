...
DISCOVERY_SYSTEM_PROMPT = (
    ...
    "always include 2-3 concrete suggestions they can pick from, not open-ended "
    "questions.\n\n"
    ...
    "  Step 2. Suggest scope with concrete options: 'Which business unit and "
    "region — for example: Legal Review / US, Procurement / EMEA, Sales / "
    "Global?' Stash the user's reply into target_description. Then immediately "
    "advance to Step 3.\n"
